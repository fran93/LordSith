...
public enum TechnologyEnum {
	...
	KLEINER_TRANSPORTER(202, TypeEnum.SPACESHIPS, new Resources(2000, 2000), 1),
	GROSSER_TRANSPORTER(203, TypeEnum.SPACESHIPS, new Resources(6000, 6000), 1),
	LEICHTER_JAGER(204, TypeEnum.SPACESHIPS, new Resources(3000, 1000), 1),
	SCHWERER_JAGER(205, TypeEnum.SPACESHIPS, new Resources(6000, 4000), 1),
	KREUZER(206, TypeEnum.SPACESHIPS, new Resources(20000, 7000, 2000), 1),
	SCHLACHTSCHIFF(207, TypeEnum.SPACESHIPS, new Resources(45000, 15000), 1),
	SPIONAGESONDE(210, TypeEnum.SPACESHIPS, new Resources(0, 100), 1),
	BOMBER(211, TypeEnum.SPACESHIPS, new Resources(50000, 25000, 15000), 1),
	SOLARSATELLIT(212, TypeEnum.SPACESHIPS, new Resources(0, 2000, 500), 1),
	ZERSTORER(213, TypeEnum.SPACESHIPS, new Resources(60000, 5000, 15000), 1),
	TODESSTERN(214, TypeEnum.SPACESHIPS, new Resources(5000000, 4000000, 1000000), 1),
	SCHLACHTKREUZER(215, TypeEnum.SPACESHIPS, new Resources(30000, 40000, 15000), 1),
	REAPER(218, TypeEnum.SPACESHIPS, new Resources(85000, 55000, 20000), 1),
